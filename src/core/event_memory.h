...
/** LARGE 数据 Slab 是否启用 */
#define EVENT_SLAB_LARGE_ENABLED      IS_ENABLED(CONFIG_EVENT_SLAB_LARGE_ENABLE)

/** 256 字节数据 Slab 是否可用 */
#define EVENT_SLAB_256_AVAILABLE      (EVENT_SLAB_LARGE_ENABLED && (CONFIG_EVENT_SLAB_LARGE_256_COUNT > 0))

/** 1KB 数据 Slab 是否可用 */
#define EVENT_SLAB_1K_AVAILABLE       (EVENT_SLAB_LARGE_ENABLED && (CONFIG_EVENT_SLAB_LARGE_1K_COUNT > 0))

/** 4KB 数据 Slab 是否可用 */
#define EVENT_SLAB_4K_AVAILABLE       (EVENT_SLAB_LARGE_ENABLED && (CONFIG_EVENT_SLAB_LARGE_4K_COUNT > 0))
